...
typedef enum {OK, MAX_TAREFA, SEM_TAREFAS, NAO_ENCONTRADO, ABRIR, FECHAR, ESCREVER, LER, PRIORIDADE, TAREFAS_CATEGORIA_NAO_ENCONTRADA, EXPORTAR_ARQUIVO, EXPORTAR_BINARIO, CARREGAR_BINARIO} ERROS;
